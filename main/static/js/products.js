...
function initializeCategoryDropdown() {
    ...
    const expandButtons = categoryDropdown.querySelectorAll('.expand-children-btn');
    ...
    function expandToSelectedCategory() {
        const selectedRadio = categoryDropdown.querySelector('.category-radio:checked');
        ...
        while (parentContainer) {
            ...
            const expandBtn = categoryDropdown.querySelector(`[data-category-id="${parentId}"]`);
            ...
            parentContainer = parentContainer.parentElement.closest('.children-container');
        }
    }
...
function clearFilter(filterType) {
    if (filterType === 'category') {
        const allCategoriesRadio = document.querySelector('input[name="category"][value=""]');
        ...
        if (categoryDropdown) {
            ...
            const allOption = categoryDropdown.querySelector('.category-option[data-category-value=""]');
...
function updateActiveFilters(filters = null) {
    ...
    if (filters.search) {
        filtersHtml += `
            <span class="active-filter">
                ...
                <button type="button" onclick="clearFilter('search')" data-filter="search">×</button>
            </span>
        `;
    }
    ...
    if (filters.category) {
        ...
        filtersHtml += `
            <span class="active-filter">
                ...
                <button type="button" onclick="clearFilter('category')" data-filter="category">×</button>
            </span>
        `;
    }
    ...
    if (filters.price_min || filters.price_max) {
        ...
        filtersHtml += `
            <span class="active-filter">
                Цена: ${min} - ${max} ₽
                <button type="button" onclick="clearFilter('price')" data-filter="price">×</button>
            </span>
        `;
    }
    ...
    if (filters.in_stock === 'true') {
        filtersHtml += `
            <span class="active-filter">
                Только в наличии
                <button type="button" onclick="clearFilter('in_stock')" data-filter="in_stock">×</button>
            </span>
        `;
    }
    ...
    activeFiltersContainer.querySelectorAll('.active-filter button').forEach(button => {
