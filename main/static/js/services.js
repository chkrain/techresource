...
function initProjectsGallery() {
    const projectsData = {
        1: {
            id: 1,
            title: "SCADA система Grafana",
            subtitle: "Мониторинг промышленного оборудования",
            image: "/static/images/img/grafana2sca.jpg",
            description: "Разработка современной SCADA системы для мониторинга промышленного оборудования с использованием Grafana. Система позволяет отслеживать параметры оборудования в реальном времени, генерировать отчеты и настраивать уведомления.",
            details: [
        ...
        2: {
            id: 2,
            title: "SCADA для покраски фанеры",
        ...
        3: {
            id: 3,
            title: "SCADA для переработки трепела",
        ...
        5: {
            id: 5,
            title: "SCADA для гипсового производства",
        ...
        6: {
            id: 6,
            title: "SCADA для производства каучука",
        ...
        7: {
            id: 7,
            title: "SCADA для обогащения песка",
        ...
        10: {
            id: 10,
            title: "SCADA для фасовки трепела",
        ...
        12: {
            id: 12,
            title: "Универсальная SCADA на Grafana",
            subtitle: "Многофункциональная система",
            image: "/static/images/img/grafanasca.jpg",
            description: "Разработка универсальной SCADA системы на базе Grafana для различных отраслей промышленности с модульной архитектурой.",
            details: [
            ...
            techTags: ["Grafana", "SCADA", "Универсальная", "Кроссплатформенность"],
            gallery: []
        }
    };
